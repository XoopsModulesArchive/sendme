...
* This File (getfile.php) , is a Hack I found Online , I can not give Credits as i do not know who Published It , Sorry :)
*/
...
//<a href="download.php?file=file.png">Download</a>
//$hiddenPath = "store/";
$hiddenPath = $xoopsModuleConfig['upload_store'];
// VARIABLES
if (!empty($_GET['file'])){
...
echo("U Not allowed to do this Operation!");
die();
}
...
// Requested file does not exist (File not found)
	echo ""._MI_SENDME_ATTACHMENTS_NOT_FOUND."";
